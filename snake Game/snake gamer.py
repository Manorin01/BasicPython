...
class Snake(Canvas):
	...
	def move_snake(self):
		...
		for segment,pos in zip(findsnake,self.snake_positions):
			#zip(findsnake,self.snake_positions) = [(segment,(120,100)),(segment,(120,100)),(segment,(120,100))]
	...
	def check_food_collistions(self):
...
GUI = Tk()
GUI.title('Snake Game Nokia 3310 by Manorin')
